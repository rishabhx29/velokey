...
function MinimalKeyboardKeys() {
  ...
  return (
    <div>
      {/* Borderless surface */}
      <div
        className="h-fit w-fit rounded-[12px] p-[6px]"
        style={{
          background:
      ...
      >
        <div className="h-[274px] overflow-hidden rounded-[8px]">
...
function K({ w = 50, children, className, kc }: MinimalKeyProps) {
  ...
  return (
    <button
      ...
      className="flex cursor-pointer touch-none appearance-none items-center justify-center border-0 bg-transparent p-0 focus:outline-none"
    >
      <div
        className="flex items-center justify-center rounded-[6px] transition-all duration-[120ms] ease-out"
        style={{
          width: `${innerW}px`,
          height: "44px",
          background: active
