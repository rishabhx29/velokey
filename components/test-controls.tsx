...
import { IconAt, IconClock, IconLetterA, IconQuote, IconMountain, IconNumber, IconFeather, IconBolt, IconFlame, IconTool, IconPencil, IconAdjustments, IconX, IconCode, IconBrain, IconTarget, } from "@tabler/icons-react";
...
export const TestControls = memo(function TestControls({
  ...
  const btnClass = (active: boolean) => cn(
    "group relative flex items-center justify-center gap-1.5 rounded-lg px-3.5 h-full text-xs font-medium transition-all duration-200 cursor-pointer select-none",
    active
      ? "text-foreground bg-background dark:bg-zinc-800/90 shadow-sm ring-1 ring-border/80 scale-[1.02]"
      : "text-muted-foreground/80 hover:text-foreground hover:bg-background/40 active:scale-95",
  );

  const drawerBtnClass = (active: boolean) => cn(
    "flex flex-col items-center justify-center gap-1 rounded-xl p-2.5 text-xs font-medium transition-all duration-200 border cursor-pointer select-none",
    active
      ? "border-primary/50 bg-primary/10 text-primary shadow-xs scale-[1.02]"
      : "border-border/60 bg-zinc-100/80 dark:bg-zinc-800/80 text-muted-foreground hover:text-foreground hover:border-border active:scale-95",
  );
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {([
                    ...
                    { key: "medium", icon: IconBolt, label: "medium", active: difficulty === "medium", d: "medium" as const },
  ...
  return (
    <>
      ...
      >
        ...
        <div className="hidden lg:flex items-center justify-center gap-2.5 mt-6 whitespace-nowrap scale-88 origin-top rounded-2xl border border-border/60 bg-background/40 p-2 shadow-xs backdrop-blur-md">
